/**
 * seed-admin.js — bootstrap the first admin user (Maria) in the database.
 *
 * Usage:
 ...
 *
 * Override defaults:
 *   SEED_USERNAME=mariaadmin SEED_EMAIL=maria@example.com SEED_PASSWORD=Secret99 npm run seed-admin:dev
 *
...
const NAME = process.env.SEED_NAME ?? "Maria";
const USERNAME = process.env.SEED_USERNAME ?? "mariaadmin";
const EMAIL = process.env.SEED_EMAIL ?? "maria@example.com";
