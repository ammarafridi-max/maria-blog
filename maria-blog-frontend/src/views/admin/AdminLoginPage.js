      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-primary-950 via-primary-900 to-primary-800 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-primary-200 text-base leading-relaxed max-w-sm">
            Write and publish physiotherapy articles, organise them by topic,
            and manage your team from one secure dashboard.
          </p>

          <div className="mt-10 grid grid-cols-2 gap-4">
            {[
              { label: 'Blog', value: 'Write & publish' },
              { label: 'Tags', value: 'Organise topics' },
              { label: 'Scheduling', value: 'Publish ahead' },
              { label: 'Team', value: 'Manage writers' },
            ].map(({ label, value }) => (
              <div
                key={label}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-2 mb-8">
            <Activity size={22} className="text-primary-700" />
